              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="p-6 space-y-3">
                    ...
                    {order.status === "pendiente" &&
                      order.paymentMethod === "mercadopago" && (
                        <button
                          ...
                          className="w-full flex items-center justify-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-md transition-colors"
                        >
                          Completar pago
                        </button>
                      )}
                    ...
                    {order.paymentMethod === "whatsapp" && (
                      <Link
                        href={`https://wa.me/5491112345678?text=Hola,%20consulto%20por%20mi%20pedido%20%23${order._id.substring(
                          0,
                          8
                        )}`}
                        target="_blank"
